const STORE = {
  questions: {
    ...
    arrays: [
      {
        question:
          "Qual é o valor médio da taxa para emitir a 2ª via do CRLV em MG?",
        code: `Calculo`,
        answers: [
          "Isento de cobrança",
          "Entre R$ 20 e R$ 40",
      ...
      },
      {
        ...
        answers: [
          ...
          "Não, basta comparecer ao Detran",
      ...
      {
        question: "Qual o site oficial para acessar serviços do Detran-MG?",
        code: `Online`,
        answers: [
          "www.detran.gov.br",
          "www.detran.mg.gov.br",
          "www.servicos.mg.detran.br",
          "www.cnhmg.com.br",
        ],
        correctAnswer: "www.detran.mg.gov.br",
      },
      {
        question:
          "Para que tipo de documento pode ser solicitada a 2ª via pelo Detran-MG?",
        code: `Motorista`,
        answers: [
          "Apenas CNH",
          "Somente o CRLV",
 ...
 ...
      ...
      },
      {
        ...
        answers: [
          ...
          "No telefone da Ouvidoria do Detran-MG",
          "Por meio de um despachante",
          "No aplicativo do governo estadual",
        ],
        correctAnswer: "No telefone da Ouvidoria do Detran-MG",
      },
      {
        question: "Qual o nome do sistema que permite acessar o CRLV digital?",
        code: `-e`,
        answers: ["CRLV-e", "DetranDigital", "CNH Digital", "CarteiraVeicular"],
        correctAnswer: "CRLV-e",
      },
    ],
    forms: [
      {
        ...
        code: ``,
        answers: [
          "No CRLV antigo ou no site do Detran-MG",
          "Apenas no documento original",
          "No banco autorizado",
          "Na placa do veículo",
        ],
        correctAnswer: "No CRLV antigo ou no site do Detran-MG",
      },
      {
      ...
      {
        question:
          "Caso o veículo tenha financiamento ativo, o que é necessário para solicitar a 2ª via do CRLV?",
        code: ``,
        answers: [
      ...
      {
        question:
          "Qual documento é exigido para comprovar a propriedade do veículo no Detran-MG?",
        code: ``,
        answers: [
    ...
    loops: [
      {
        question:
          "A 2ª via do CRLV digital pode ser acessada por qual aplicativo?",
        code: ``,
        answers: [
          "Detran Digital",
      ...
      {
        question:
          "Qual é o prazo máximo para pagamento da guia emitida pelo Detran-MG?",
        code: ``,
        answers: [
          "24 horas",
          "7 dias úteis",
      ...
      },
      {
        ...
        code: ``,
        answers: [
          "Chat online no site do Detran-MG",
          "Ouvidoria da Prefeitura",
          "Central de atendimento do Detran-MG",
          "Aplicativo de mensagens do governo",
        ],
        correctAnswer: "Central de atendimento do Detran-MG",
      },
      {
        question:
          "É possível solicitar a 2ª via do CRLV para veículos com IPVA atrasado?",
        code: ``,
        answers: [
      ...
      {
        question:
          "Em qual horário as unidades do Detran-MG geralmente funcionam para retirada de documentos?",
        code: ``,
        answers: [
          "Das 7h às 12h",
          "Das 8h às 17h",
    ...
    methods: [
      {
        question: "Quem é responsável por emitir o CRLV-e?",
        code: ``,
        answers: [
          "Secretaria de Fazenda do Estado",
          "O proprietário, por meio do sistema digital",
          "O banco onde foi pago o boleto",
          "Detran-MG, após a confirmação do pagamento",
        ],
        correctAnswer: "Detran-MG, após a confirmação do pagamento",
      },
      {
        question:
          "O que deve ser feito se a guia de pagamento não for gerada corretamente no site do Detran-MG?",
        code: ``,
        answers: [
      ...
      {
        question:
          "Em qual seção do site do Detran-MG você pode solicitar a 2ª via do CRLV?",
        code: ``,
        answers: [
          "Renovação de CNH",
          "Veículos",
      ...
      {
        question:
          "Qual é o principal meio de recebimento da 2ª via do CRLV em formato digital?",
        code: ``,
        answers: [
          "E-mail cadastrado no Detran",
          "Aplicativo Carteira Digital de Trânsito (CDT)",
          "WhatsApp do Detran-MG",
          "Download direto do site do Detran-MG",
        ],
    ...
    CSS: [
      {
        question:
          "O que acontece se você não portar o CRLV durante uma fiscalização?",
        code: ``,
        answers: [
      ...
      {
        question:
          "É necessário fazer vistoria no veículo para solicitar a 2ª via do CRLV?",
        code: ``,
        answers: [
          "Sim, sempre",
      ...
      {
        question:
          "Qual o nome do documento que substitui o CRLV físico atualmente?",
        code: ``,
        answers: [
          "CRLV Digital (CRLV-e)",
        ...
        correctAnswer: "CRLV Digital (CRLV-e)",
      },
      {
        question:
          "Quais são as formas de pagamento da taxa de 2ª via aceitas pelo Detran-MG?",
        code: ``,
        answers: [
      ...
      {
        question: "Solicite 2ª Via Detran-MG Online?",
        code: ``,
        answers: [
          "Pague Sua 2ª Via do CRLV Agora",
          "Resolva Multas e Emita o CRLV",
          "Guia Rápida para a 2ª Via do Detran",
          "Evite Multas: CRLV Fácil e Rápido",
        ],
        correctAnswer: "Pague Sua 2ª Via do CRLV Agora",
      },
    ],
    conditionals: [
      {
        question: "Emissão Rápida do CRLV Digital?",
        code: ``,
        answers: [
          "Guia Completa para Documentos Detran",
          "2ª Via do CRLV com Suporte Completo",
          "Renove Já Seus Documentos no Detran",
          "Solicite 2ª Via Detran-MG Online",
        ],
        correctAnswer: "Solicite 2ª Via Detran-MG Online",
      },
      {
        question: "Resolva Multas e Emita o CRLV?",
        code: ``,
        answers: [
          "Guia Rápida para a 2ª Via do Detran",
          "Evite Multas: CRLV Fácil e Rápido",
          "2ª Via de Documentos no Detran-MG",
          "Emissão Rápida do CRLV Digital",
        ],
        correctAnswer: "Emissão Rápida do CRLV Digital",
      },
      {
        question: "Guia Completa para Documentos Detran?",
        code: ``,
        answers: [
          "2ª Via do CRLV com Suporte Completo",
          "Renove Já Seus Documentos no Detran",
        ...
        correctAnswer: "Guia Rápida para a 2ª Via do Detran",
      },
      {
        question: "Evite Multas: CRLV Fácil e Rápido?",
        code: ``,
        answers: [
          "2ª Via de Documentos no Detran-MG",
          "Emissão Rápida do CRLV Digital",
        ...
        correctAnswer: "2ª Via do CRLV com Suporte Completo",
      },
      {
        question: "Renove Já Seus Documentos no Detran?",
        code: ``,
        answers: [
          "Solicite 2ª Via Detran-MG Online",
          "Pague Sua 2ª Via do CRLV Agora",
    ...
    objects: [
      ...
      {
        question: "Guia Rápida para a 2ª Via do Detran?",
        code: ``,
        answers: [
          "Evite Multas: CRLV Fácil e Rápido",
          "2ª Via de Documentos no Detran-MG",
      ...
      },
      {
        ...
        correctAnswer: "Guia Completa para Documentos Detran",
      },
    ],
  },
};
